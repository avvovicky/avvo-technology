...
<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700&display=fallback">
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="./public/templates/AdminLTE-3.2.0/plugins/fullcalendar/main.css">
  <!-- Theme style -->
            ...
            <div class="sticky-top mb-3">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title">Estados auxiliares</h4>
                </div>
                <div class="card-body">
                  <!-- the events -->
                  <div id="external-events">
                    <div class="external-event bg-success">Inicio de turno</div>
                    <div class="external-event bg-warning">Break</div>
                    <div class="external-event bg-warning">Almuerzo</div>
                    <div class="external-event bg-info">Capacitación</div>
                    <div class="external-event bg-primary">Pausas activas</div>
                    <div class="external-event bg-danger">Fin de turno</div>
                    <div class="checkbox">
...
<!-- jQuery UI -->
<script src="./public/templates/AdminLTE-3.2.0/plugins/jquery-ui/jquery-ui.min.js"></script>
<!-- AdminLTE App -->
<script src="./public/templates/AdminLTE-3.2.0/dist/js/adminlte.min.js"></script>
<!-- fullCalendar 2.2.5 -->
<script src="./public/templates/AdminLTE-3.2.0/plugins/moment/moment.min.js"></script>
<script src="./public/templates/AdminLTE-3.2.0/plugins/fullcalendar/main.js"></script>
<!-- AdminLTE for demo purposes -->
<script src="./public/templates/AdminLTE-3.2.0/dist/js/demo.js"></script>
